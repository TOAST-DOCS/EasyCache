...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (replication group details not in ko outline) -->
### Replication Group
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (monitoring details not in ko outline) -->
### Monitoring

* You can view the measurements to monitor the cache performance of the server in graphs.

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (backup details not in ko outline) -->
### Backup
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (profile configuration not in ko outline) -->
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (alarm details not in ko outline) -->
### Alarm
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (event details not in ko outline) -->
### Event
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (duplicate replication group not in ko outline) -->
### Replication Group
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (availability zone details not in ko outline) -->
### Availability Zone

* A logical area where a replication group is created.

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (floating IP details not in ko outline) -->
### Floating IP
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (high availability details not in ko outline) -->
