...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (replication group subsection not in ko outline) -->
### レプリケーショングループ
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (monitoring subsection not in ko outline) -->
### モニタリング

* サーバーのキャッシュ性能をモニタリングするために必要な測定値をグラフで確認できます。

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (backup subsection not in ko outline) -->
### バックアップ
* メモリデータを毎日1回、指定した時間に自動的にバックアップできます。
* メモリデータを好きなタイミングで即時に手動でバックアップできます。
* 安全な外部ストレージに保存します。

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (profile settings subsection not in ko outline) -->
### プロファイル設定

* Valkey及びRedisサーバーの設定情報をプロフィールとして管理できます。
* 基本(default)プロフィールとユーザープロフィールのいずれかを設定できます。

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (notification subsection not in ko outline) -->
### 通知

* レプリケーショングループのイベントとレプリケーショングループのモニタリングの通知を受け取れます。
* イベントとモニタリングのしきい値設定を管理できます。

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (event subsection not in ko outline) -->
### イベント

* レプリケーショングループとノードの状態情報を検索、確認できます。

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (terminology section not in ko outline) -->
## 用語説明

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (replication group term not in ko outline) -->
### レプリケーショングループ
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (availability zone term not in ko outline) -->
### アベイラビリティゾーン

* レプリケーショングループが作成される論理的な領域を意味します。

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (floating IP term not in ko outline) -->
### Floating IP
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (high availability term not in ko outline) -->
### 高可用性(自動HA)
